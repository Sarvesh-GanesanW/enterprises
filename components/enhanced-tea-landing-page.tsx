  ...
  return (
    <div className="flex flex-col min-h-screen bg-amber-50 bg-[url('/tea-pattern.png')] bg-repeat bg-opacity-5">
      <header className="w-full bg-white bg-opacity-90 backdrop-blur-sm sticky top-0 z-50 shadow-sm">
        <div className="container mx-auto px-4 h-20 flex items-center justify-between">
          ...
          <nav className="flex gap-4 sm:gap-6">
            <Link className="text-sm font-medium hover:text-amber-600 transition-colors text-amber-800" href="#products">
              Products
            </Link>
            <Link className="text-sm font-medium hover:text-amber-600 transition-colors text-amber-800" href="#about">
              About Us
            </Link>
            <button
              onClick={() => setIsContactModalOpen(true)}
              className="text-sm font-medium hover:text-amber-600 transition-colors text-amber-800"
            >
              Contact
            </button>
          </nav>
      ...
      <main className="flex-1">
        ...
        <section id="about" className="w-full py-12 md:py-24 lg:py-32 bg-white bg-opacity-80">
          <div className="container mx-auto px-4 md:px-6">
            <h2 className="text-3xl font-bold tracking-tighter sm:text-4xl md:text-5xl text-amber-800 text-center mb-8">
              About Us
            </h2>
            <p className="text-amber-700 text-lg text-center max-w-3xl mx-auto">
              Sree Rajalakshmi Enterprises has been a beacon of quality in the tea industry for four decades. 
              Our journey began in the lush tea gardens of South India, where we cultivated a deep understanding and 
              appreciation for the art of tea making. Today, we pride ourselves on delivering the finest tea 
              experiences to our customers, blending traditional wisdom with modern innovation. Our commitment to 
              quality, sustainability, and customer satisfaction has made us a trusted name in the world of tea.
            </p>
          </div>
        </section>
              ...
              {[
                ...
                <Card key={index} className="bg-amber-50 rounded-2xl overflow-hidden shadow-md hover:shadow-xl transition-shadow duration-300">
                  ...
                  <CardContent className="p-6">
                    ...
                    <div className="space-y-2">
                      <p className="text-sm text-amber-600">Retail: {product.retailPrice}</p>
                      <p className="text-sm text-amber-600">Wholesale: {product.wholesalePrice}</p>
                    </div>
                  </CardContent>
                </Card>
              ))}
              ...
              <Dialog>
                ...
                <DialogContent className="sm:max-w-[425px]">
                  ...
                  <form className="space-y-4">
                    ...
                    <Button type="submit" className="w-full bg-amber-600 hover:bg-amber-700 text-white">Submit Order</Button>
                  </form>
                </DialogContent>
              </Dialog>
            </div>
        ...
        <div className="container mx-auto px-4 md:px-6">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-12 text-center md:text-left">
            <div>
              ...
              <p className="text-sm mb-2">Phone: +91 9790847023</p>
          ...
          <div className="mt-8 border-t border-amber-700 pt-8 text-center">
      ...
      <Dialog open={isContactModalOpen} onOpenChange={setIsContactModalOpen}>
        <DialogContent className="sm:max-w-[425px]">
          ...
          <form className="space-y-4">
            ...
            <Button type="submit" className="w-full bg-amber-600 hover:bg-amber-700 text-white">Send Message</Button>
          </form>
        </DialogContent>
      </Dialog>
      <Link
